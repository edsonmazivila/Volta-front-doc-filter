...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[250px] w-full items-center justify-center overflow-hidden p-4 [mask-image:linear-gradient(to_top,transparent_5,#000_100%)]"
      ref={containerRef}
    >
...
const Icons = {
	quickbooks: () => (
		<Image src="/icons/quickbooks.svg" alt="QuickBooks" width={50} height={50} className="w-12 h-12" />
	),
	slack: () => (
		<Image src="/icons/slack.svg" alt="Slack" width={50} height={50} className="w-12 h-12" />
	),
	docusign: () => (
		<Image src="/icons/docusign.svg" alt="DocuSign" width={50} height={50} className="w-12 h-12" />
	),
	clockify: () => (
		<Image src="/icons/clockify.svg" alt="Clockify" width={50} height={50} className="w-12 h-12" />
	),
	stripe: () => (
		<Image src="/icons/stripe.svg" alt="Stripe" width={50} height={50} className="w-12 h-12" />
	),
	googleSheets: () => (
		<Image src="/icons/google-sheets.svg" alt="Google Sheets" width={50} height={50} className="w-12 h-12" />
	),
  notion: () => (
    <svg
      width="100"
  ...
  openai: () => (
    <Image src="/logo/SVG/symbol-purple-1000x460.svg" alt="Logo" className="w-auto h-10" width={35} height={40}/>
  ),
  googleDrive: () => (
    <svg
      width="100"
